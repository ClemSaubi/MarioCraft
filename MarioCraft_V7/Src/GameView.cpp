...
void GameView::Display()
{
    ...
    string type = "";
    int vie = 0;
    int nourriture = _model->getJoueur1()->getQuantiteNourriture();
    int bois = _model->getJoueur1()->getQuantiteBois();
    int artisans = _model->getJoueur1()->getCompteurArtisans();
    int pos_x_elem = 0;
    int pos_y_elem = 0;
    ...
    String _indic_nourriture = String(_model->getJoueur1()->intToString(nourriture));
    ...
    String _indic_artisans = String(_model->getJoueur1()->intToString(artisans));
    ...
    String _indic_bois = String(_model->getJoueur1()->intToString(bois));
    ...
    for (int i = 0; i < _model->getJoueur1()->getListElementSize(); ++i)
    {
        type = _model->getJoueur1()->getElement(i)->getType();
        vie = _model->getJoueur1()->getElement(i)->getVie();
        pos_x_elem = _model->getJoueur1()->getElement(i)->getPosX();
        pos_y_elem = _model->getJoueur1()->getElement(i)->getPosY();

        if (_model->getJoueur1()->getElement(i)->estActif() == true)
        {
            String _indic_vie = String(_model->getJoueur1()->intToString(vie));
        ...
        if (_model->getJoueur1()->getElement(i)->estCible() == true)
        {
        ...
        if (type == "Foyer")
        {
            _foyer_sprite.SetPosition(_model->getJoueur1()->getElement(i)->getPosX(), _model->getJoueur1()->getElement(i)->getPosY());
            _window->Draw(_foyer_sprite);
        }
        if (type == "Caserne")
        {
            _caserne_sprite.SetPosition(_model->getJoueur1()->getElement(i)->getPosX(), _model->getJoueur1()->getElement(i)->getPosY());
            _window->Draw(_caserne_sprite);
        }
        if (type == "Bois")
        {
            _bois_sprite.Resize(DIMENSION_SPRITE, DIMENSION_SPRITE);
            _bois_sprite.SetPosition(_model->getJoueur1()->getElement(i)->getPosX(), _model->getJoueur1()->getElement(i)->getPosY());
            _window->Draw(_bois_sprite);
        }
        if (type == "Nourriture")
        {
            _nourriture_sprite.Resize(DIMENSION_SPRITE, DIMENSION_SPRITE);
            _nourriture_sprite.SetPosition(_model->getJoueur1()->getElement(i)->getPosX(), _model->getJoueur1()->getElement(i)->getPosY());
            _window->Draw(_nourriture_sprite);
        }
        if (type == "Artisan")
        {
            _artisan_sprite.Resize(DIMENSION_SPRITE, DIMENSION_SPRITE);
            _artisan_sprite.SetPosition(_model->getJoueur1()->getElement(i)->getPosX(), _model->getJoueur1()->getElement(i)->getPosY());
